...
{
  public class FaceMeshMoreFaces : MonoBehaviour
  {
    ...
    private IEnumerator Start()
    {
      ...
      yield return AssetLoader.PrepareAssetAsync("face_landmark_with_attention.bytes", "face_landmark_with_attention.bytes", false);
      ...
      // sidePacket.Emplace("num_faces", new IntPacket(2)); // Vimal - setting the max number of faces here
